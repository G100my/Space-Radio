...
!(function (e) {
  ...
  function (e, t, n) {
    ...
    function r() {
      ...
      if (((window.Spotify = { Player: e.setupPlayerEnv(window) }), window.onSpotifyWebPlaybackSDKReady))
        ...
        return (
          ...
          (f.prototype.on = function (e, t) {
            ...
            return (
              ...
              -1 === this._eventListeners[e].indexOf(t) && (this._eventListeners[e].push(t), !0)
            )
          }),
          ...
          (f.prototype._onConnected = function (e) {
            e.ref in this._connectionRequests &&
              (this._connectionRequests[e.ref].resolve(e.connected), delete this._connectionRequests[e.ref])
          }),
          (f.prototype._onCurrentState = function (e) {
            e.ref in this._getCurrentStateRequests &&
              (this._getCurrentStateRequests[e.ref].resolve(e.state), delete this._getCurrentStateRequests[e.ref])
          }),
          (f.prototype._onVolume = function (e) {
            e.ref in this._getVolumeRequests &&
              (this._getVolumeRequests[e.ref].resolve(e.volume), delete this._getVolumeRequests[e.ref])
          }),
