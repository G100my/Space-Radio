    ...
    <div class="track-table">
      ...
      <Track v-for="queueKey in urgentQueueKeys" :key="queueKey" :info="trackData[queueKey]" :is-urgent="true">
        <div class="feature-buttons">
          ...
          <button class="edit-button" type="button" @click="editNote(queueKey, trackData[queueKey].name)">
            <!-- prettier-ignore -->
      ...
      <Track v-for="queueKey in normalQueueKeys" :key="queueKey" :info="trackData[queueKey]">
        <div class="feature-buttons">
          ...
          <button class="normal2urgent-button" type="button" @click="normal2urgent(queueKey, trackData[queueKey].name)">
            <!-- prettier-ignore -->
