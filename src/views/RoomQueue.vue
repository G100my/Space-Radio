    ...
    <div class="track-table">
      ...
      <Track v-for="(detailObject, key) in urgentTrack" :key="key" :info="detailObject" :is-urgent="true">
        <div class="feature-buttons">
          ...
          <button class="edit-button" type="button" @click="editNote(key)">
            <!-- prettier-ignore -->
      ...
      <Track v-for="(detailObject, key) in normalTrack" :key="key" :info="detailObject">
        <div class="feature-buttons">
          ...
          <button class="normal2urgent-button" type="button" @click="normal2urgent(key)">
            <!-- prettier-ignore -->
...
export default {
  ...
  methods: {
    ...
    editNote(key) {
      ...
      this.$emit('activeNoteDialog', key, 'urgent', submitFunction)
    },
    urgent2normal(key) {
    ...
    normal2urgent(key) {
      ...
      this.$emit('activeNoteDialog', key, 'normal', submitFunction)
    },
  },
}
</script>
