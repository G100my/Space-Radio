<template>
  <div class="room-queue">
    <TrackGridShell>
      ...
      <template #body>
        <div class="playlist flex items-center rounded-lg bg-tertiary-dark-60 py-3 px-10">
          <div class="status pr-10">
            <div class="pending">
          ...
          <div class="song-details flex pr-24">
            <div class="album-img pr-4">
              <img src="@/assets/images/fake-album-photo.png" alt="">
            </div>
            <div class="song">
              <p class="name text-natural-gray1 font-bold">Until Our Next Adventure</p>
              <p class="orderer text-primary">Lo</p>
            </div>
          </div> 
          <div class="album text-natural-gray1 pr-40">
            <div class="album-name">
              Album Name
            </div>
            <div class="album-author text-xs">
              Coldplay
            </div>
          </div>
          <div class="features text-right flex justify-end flex-auto">
            <button class="pr-11">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect width="24" height="24" fill="none"/>
